...
function MainGroup({ theme, change }: ThemeGroupProps) {
  return (
    <Array>
      ...
      />
      <Mode mode={theme.engine} onChange={(mode) => change({ engine: mode })} />
    </Array>
  );
}
...
function ColorsGroup({ theme, change }: ThemeGroupProps) {
  ...
  return (
    <Array>
      ...
      <TextColor
        value={
          theme[fgProp] === "auto" ? defaultSchemeColors.text : theme[fgProp]
        }
      ...
      <Scrollbar
        ...
        onReset={() =>
          change({ scrollbarColor: DEFAULT_SETTINGS.theme.scrollbarColor })
        }
      />
      <SelectionColorEditor
        ...
        onReset={() =>
          change({ selectionColor: DEFAULT_SETTINGS.theme.selectionColor })
        }
      />
    </Array>
  );
