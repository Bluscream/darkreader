...
function Body({ data, tab, actions }: BodyProps) {
  ...
  return (
    <body>
      ...
      <textarea id="editor" onrender={onTextRender} />
      <label id="error-text">{state.errorText}</label>
      <div id="buttons">
        <Button onclick={reset}>Reset</Button>
        <Button onclick={apply}>Apply</Button>
        <Button class="preview-design-button" onclick={toggleDesign}>
          {previewButtonText}
        </Button>
      </div>
      <p id="description">
        ...
        . If a <strong>popular</strong> website looks incorrect e-mail to{" "}
